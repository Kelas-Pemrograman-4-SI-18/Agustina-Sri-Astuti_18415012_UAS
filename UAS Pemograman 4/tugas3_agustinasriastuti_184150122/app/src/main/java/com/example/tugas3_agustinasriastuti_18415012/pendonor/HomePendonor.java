package com.example.tugas3_agustinasriastuti_18415012.pendonor;
...
import com.example.tugas3_agustinasriastuti_18415012.DetailDarah;
...
import com.example.tugas3_agustinasriastuti_18415012.pmr.DataDarah;
import com.example.tugas3_agustinasriastuti_18415012.pmr.EditData;
...
public class HomePendonor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_pendonor);

        prefSetting = new PrefSetting(this);
        prefs = prefSetting.getSharePreferences();

        session = new SessionManager(HomePendonor.this);
        ...
        floatingActionButton = (FloatingActionButton) findViewById(R.id.exit);
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                session.setLogin(false);
                session.setSessid(0);
                Intent i = new Intent(HomePendonor.this, Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        newsList.clear();
        adapter = new AdapterDarah(HomePendonor.this, newsList);
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(HomePendonor.this, DetailDarah.class);
...
//        Intent i = new Intent(HomePendonor.this, HomeAdmin.class);
//        startActivity(i);
//        finish();
//    }
